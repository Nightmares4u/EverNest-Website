...
export const successStories: SuccessStory[] = [
  {
    id: "ahsan-nazir-italy",
    clientName: "Ahsan Nazir",
    serviceType: "Italy Student Visa · Electronic Engineering at University of Rome Tor Vergata",
    destinationCountry: "Italy",
    outcomeLabel: "Visa Approved",
    rating: 5,
    reviewSource: "google",
    testimonialQuote:
      "I am extremely grateful for their expert guidance and support in securing my Italian student visa. The process was smooth and stress-free thanks to their professionalism and dedication. Highly recommend their services to anyone planning to study abroad",
    imagePath: "/images/success-stories/ahsan-nazir-italy.jpeg",
    imageAlt: "Ahsan Nazir in a black shirt with Sir Raza holding his Italian student visa",
    imageFit: "contain",
  ...
  {
    id: "saim-khalid-italy",
    clientName: "Saim Khalid",
    serviceType: "Italy Student Visa · Bachelor's in Computer Engineering at University of Cassino",
    destinationCountry: "Italy",
    outcomeLabel: "Visa Approved",
    rating: 5,
    reviewSource: "direct",
    testimonialQuote:
      "EverNest Consultants guided me clearly through my Italy study visa process, from university selection and documentation to visa approval. Their support helped me secure admission to the University of Cassino for a Bachelor's in Computer Engineering. The team's professionalism and timely guidance made the entire process smooth and stress-free. I highly recommend EverNest to students planning to study abroad.",
    imagePath: "/images/success-stories/saim-khalid-italy.jpeg",
    imageAlt: "Saim Khalid in a green shirt and glasses with Sir Raza holding his Italian student visa",
    imageFit: "contain",
    mobileImageFit: "contain",
    imagePosition: "center center",
    featured: true,
